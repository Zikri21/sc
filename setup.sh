...
akbarvpnnn="raw.githubusercontent.com/Zikri21/sc/main/ssr"
# Link Hosting Kalian Untuk Shadowsocks
akbarvpnnnn="raw.githubusercontent.com/Zikri21/sc/main/shadowsocks"
...
echo " "
echo "============================-AutoScript By FriensVPN Store-============================" | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : FriensVPN"  | tee -a log-install.txt
echo "   - Recode                  : FriensVPN" | tee -a log-install.txt
echo "   - Instagram               : FriensVPN_"  | tee -a log-install.txt
echo "   - Whatsapp                : wa.me/6285789736278"  | tee -a log-install.txt
echo "   - Tele                    : t.me/Arta1ove" | tee -a log-install.txt
echo "----------------------AutoScript By FriensVPN----------------------" | tee -a log-install.txt
echo ""
echo " Reboot 15 Sec"
sleep 15
echo ""
